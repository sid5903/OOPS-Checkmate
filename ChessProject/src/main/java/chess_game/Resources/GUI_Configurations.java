...
public class GUI_Configurations {
    ...
    public static Color lightColor = new Color(238, 238, 210);
    public static Color darkColor = new Color(118, 150, 86);
    ...
    public static Color checkRedColor = new Color(255, 80, 80); // Red for check highlight
