...
public class BoardUtilities {
    ...
    public static ImageIcon getImageOfTeamPiece(Team team, PieceTypes pieceType) {
        String imagePath = "/chess_game/Img/";
        ...
        try {
            java.net.URL imgURL = BoardUtilities.class.getResource(imagePath);
            if (imgURL != null) {
    ...
    public static Tile[][] createStandartBoardTiles() {
        ...
        tiles[3][7] = new Tile(new Coordinate(3, 7), new Queen(Team.WHITE));
        tiles[4][7] = new Tile(new Coordinate(4, 7), new King(Team.WHITE));
